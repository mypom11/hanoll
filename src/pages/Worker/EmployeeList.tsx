...
const EmployeeList = () => {
  ...
  return (
    <React.Fragment>
      <BreadCrumb title="직원 목록" pageTitle="직원 관리" />
        ...
        <div className="card-body">
          <div className="flex items-center gap-3 mb-4">
            <h6 className="text-15 grow">
              직원 (<b className="total-Employs">{data.length}</b>)
            </h6>
            <div className="shrink-0">
              <Link
                ...
                <span className="align-middle">직원 추가</span>
              </Link>
            </div>
          </div>
          {data && data.length > 0 ? (
            ...
            <div className="noresult">
              <div className="py-6 text-center">
                ...
                <p className="mb-0 text-slate-500 dark:text-zink-200">
                  We've searched more than 299+ Employee We did not find any Employee for you
                  search.
                </p>
              </div>
            </div>
      ...
      <Modal
        ...
        <Modal.Header
          ...
          <Modal.Title className="text-16">{!!isEdit ? '직원 정보 수정' : '직원 추가'}</Modal.Title>
        </Modal.Header>
        <Modal.Body className="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
          <form
            ...
            <div
              id="alert-error-msg"
              className="hidden px-4 py-3 text-sm text-red-500 border border-transparent rounded-md bg-red-50 dark:bg-red-500/20"></div>
            <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
              ...
              <div className="xl:col-span-12">
                <label htmlFor="employeeId" className="inline-block mb-2 text-base font-medium">
                  사원번호
                </label>
                <input
                  type="text"
              ...
              <div className="xl:col-span-12">
                <label htmlFor="employeeInput" className="inline-block mb-2 text-base font-medium">
                  직원 명
                </label>
                <input
                  type="text"
              ...
              <div className="xl:col-span-6">
                ...
                <Flatpickr
                  ...
                  name="joinDate"
                  onChange={(date: any) =>
                    validation.setFieldValue('joinDate', moment(date[0]).format('DD MMMM ,YYYY'))
                  }
