...
const StockListView = () => {
  ...
  const filterSearchData = (e: any) => {
    ...
    const keysToSearch = ['productName_kor', 'productName', 'category', 'status'];
  ...
  const columns = useMemo(
    () => [
      ...
      {
        header: '온라인판매',
        accessorKey: 'onlineSellCount',
        enableColumnFilter: false,
        enableSorting: true,
      },
      {
        header: '오프라인판매',
        accessorKey: 'OfflineSellCount',
        enableColumnFilter: false,
        enableSorting: true,
      },
      {
            ...
            <Dropdown.Content
              ...
              <li>
                <Link
                  ...
                  <span className="align-middle">상품_수정</span>
                </Link>
              </li>
              <li>
                <Link
                  ...
                  <span className="align-middle">상품_삭제</span>
                </Link>
              </li>
            </Dropdown.Content>
          </Dropdown>
  ...
  return (
    <React.Fragment>
      <BreadCrumb title="상품 목록" pageTitle="상품 관리" />
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 xl:grid-cols-12">
            ...
            <div className="lg:col-span-2 ltr:lg:text-right rtl:lg:text-left xl:col-span-2 xl:col-start-11">
              <Link
                ...
                <span className="align-middle">상품 추가</span>
              </Link>
            </div>
          </div>
        </div>
